...
# 特定のエージェントのみ
curl -sL https://raw.githubusercontent.com/Luna-company/agent-orchestrator/main/install.sh | bash -s -- nexus rally builder radar ceo

# ローカルクローンから
git clone https://github.com/Luna-company/agent-orchestrator.git /tmp/agent-orchestrator
